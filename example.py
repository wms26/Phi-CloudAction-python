...
from PhiCloudLib.CloudAction import getPlayerId, getSummary, getSave, uploadSave, uploadSummary
...
check_saveUpload(sessionToken, summary, save, difficulty)  # 存储存档历史记录
